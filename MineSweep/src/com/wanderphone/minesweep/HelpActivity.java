...
public class HelpActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// bt_next.getBackground().setColorFilter(0xFFEEEE00,
		// PorterDuff.Mode.MULTIPLY);
		// .getBackground().setColorFilter(0xFFEEEE00,
		// PorterDuff.Mode.MULTIPLY);
		 ...
		 * stub HelpActivity.this.finish(); } }); bt_next.setOnClickListener(new
		 * OnClickListener() {
		 * 
		 * @Override public void onClick(View v) { // TODO Auto-generated method
		 * stub
		 ...
		 * help_content.setText(string4); help_title.setText(string6);
		 * flag=false; } else {
		 * bt_next.setBackgroundResource(R.drawable.button_next_click);
		 * help_content.setText(string3); help_title.setText(string5);
		 * flag=true; } }
		 * 
		 * });
		 */
