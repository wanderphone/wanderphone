			...
			public void onClick(View v) {
				...
				if (username.equals("") || username == null) {
					new AlertDialog.Builder(RegisterActivity.this)
							...
							.setPositiveButton(R.string.bt_sure,
					...
					registerUrl = getResources().getString(R.string.websit)
							+ "?phone_id=" + uniqueId
							+ "&which_use=2&username="
							+ URLEncoder.encode(username);

					String registerReturnString = HttpClientConnector
							.getStringByUrl(registerUrl);
