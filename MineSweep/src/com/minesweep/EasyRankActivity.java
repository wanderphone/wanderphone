...
public class EasyRankActivity extends ListActivity{
	...
	public void showEasyRankList(){
		new AsyncTask<Void, Void, Boolean>(){
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				try{
					final String rankInfoUrl = "http://10.0.2.2:8080/Test?level=easy&which_use=4";
			...
			protected void onPostExecute(Boolean result){
				...
				if(result)
				{
					setListAdapter(new RankListAdapter(EasyRankActivity.this,
					...
					Toast.makeText(EasyRankActivity.this, "网络数据加载失败", Toast.LENGTH_LONG).show();
				}
			}
